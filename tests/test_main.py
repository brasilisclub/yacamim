...
def test_absolutise_url(client):
    assert client.absolutise_url("gemini://example.com/", "page") == "gemini://example.com/page"
    assert client.absolutise_url("gemini://example.com/dir/", "/page") == "gemini://example.com/page"
    assert client.absolutise_url("gemini://example.com/", "gemini://other.com/page") == "gemini://other.com/page"
...
def test_create_ssl_socket(mock_create_context, mock_create_connection, client):
    ...
    result = client.create_ssl_socket(parsed_url)
...
def test_handle_redirect(client):
    assert client.handle_redirect("gemini://example.com/old", "/new") == "gemini://example.com/new"
...
def test_gemini_transaction(mock_process_response, mock_send_request, mock_create_socket, client):
    mock_socket = MagicMock()
    ...
    mock_send_request.assert_called_once_with(mock_socket, "gemini://example.com")
